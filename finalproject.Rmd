...
This cluster analysis plot distinguishes given classes. First k-means clustering was performed on the cluster data set using Lloyd's algorithm, it is an algorithm named after Stuart P. Lloyd for finding evenly spaced sets of points in subsets of Euclidean spaces and partitions of these subsets into well-shaped and uniformly sized convex cells. We used 7 clusters for this example. We then used the plotcluster() function from the library 'fpc' to plot the cluster.
